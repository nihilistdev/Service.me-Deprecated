...
CREATE INDEX document_weights_idx ON customers USING GIN (document_with_weights);
...
CREATE INDEX document_weights_idx ON country USING GIN (document_with_weights);
